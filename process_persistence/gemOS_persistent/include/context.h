...
#define CODE_START       0x1000000000
#define RODATA_START     0x1400000000
#define DATA_START       0x1800000000
#define MMAP_START       0x1802000000
#define STACK_START      0x8000000000
...
struct vm_area{
	...
	u8 is_nvm;  //is this vma physical pages allocation from NVM
...
extern struct exec_context *get_ctx_by_name(char* name);
...
extern u32 install_ptable(unsigned long base, struct  mm_segment *mm, u64 address, u32 upfn, u8 is_nvm);
extern void copy_os_pts(u64 src, u64 dst);
extern u32 map_physical_page(unsigned long base, u64 address, u32 access_flags, u32 upfn, u8 is_nvm);
...
extern int print_exec_context(struct exec_context *ctx);
extern void reset_exec_ctx();
extern int install_os_pts_range(struct exec_context *ctx, u64 start, u64 length);
extern u32 pt_walk(struct exec_context *ctx, u32 segment, u32 stack, u64 address);
extern void x86_reset_gem5_stats();
extern void x86_dump_gem5_stats();
#endif
