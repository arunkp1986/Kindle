...
int main(u64 arg1, u64 arg2, u64 arg3, u64 arg4, u64 arg5)
{
    u32 seed = 0xACE1u;
    u32 rand_value = 0;
    u32 phase1 = REC_COUNT*0.25; 
    u32 phase2 = REC_COUNT*0.50; 
    u32 phase3 = REC_COUNT*0.75; 
    u32 phase4 = REC_COUNT; 
    ...
    //unsigned end = num_blocks*4096;
    //printf("start:%lx, end:%lx, size:%u, numblocks:%u\n",(unsigned long)input,(unsigned long)&input[end-1],size,num_blocks);
