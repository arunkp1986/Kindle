...
#define CHECKPOINT_INTERVAL (ONE_MILLI_SEC*31.25) //rdtsc cycles corresponding to x milli seconds
//#define CHECKPOINT_INTERVAL (ONE_MILLI_SEC*5) //rdtsc cycles corresponding to x milli seconds
...
struct checkpoint_stats{
    u32 num;
    u32 stack_migrated_pages;
    u32 heap_migrated_pages;
