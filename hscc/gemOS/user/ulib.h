...
#define SYSCALL_MAKE_THREAD_READY 38
#define SYSCALL_WAIT_FOR_THREAD 39
#define SYSCALL_MIGRATE 40
...
extern void* umemset(void *s, int c, u32 n);
extern u32 ustrlen(char *s);

extern unsigned checkpoint_start();
extern unsigned checkpoint_end();
extern unsigned checkpoint_end2();
extern unsigned checkpoint_stats();
