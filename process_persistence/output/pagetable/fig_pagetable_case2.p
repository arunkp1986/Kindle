...
set yrange [0:]
#set logscale y 10
set xlabel "Memory Access Stride" font "helvetica, 30" offset 0,-0.5,0
set ylabel "Execution Time(msec)" font "helvetica, 30" offset -2,-0.5,0
set key left top reverse Left samplen 1 font ",25"
set output 'figure_4_b.eps'
plot "pagetable_case2.tsv" using 2:xtic(1) title 'Persistent' lc rgb blue,\
